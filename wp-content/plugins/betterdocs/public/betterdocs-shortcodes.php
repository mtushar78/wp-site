 ...
 */
function betterdocs_get_postcount($term_count=0, $term_id, $nested_subcategory=false)
{
...
function betterdocs_category_grid($atts, $content = null)
{
    ...
    $masonry = ($masonry_layout == 1 && $get_args['masonry'] == '') || ($get_args['masonry'] == true && $get_args['masonry'] != "false");
